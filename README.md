Code I wrote as part of the CMU 10701 Final Project. The task was to train a French to English machine translation model using multiple approaches. My contributions contain two parts:
